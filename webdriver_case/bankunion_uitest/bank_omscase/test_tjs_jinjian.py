...
#        u"""天交所票据进件及终定""" 
#        #起息日
#        productBreathDay =  (datetime.datetime.now() +  datetime.timedelta(days = 2)).strftime('%Y%m%d')
#        #兑付日
...
#                'raiseAmount':'80000','guaranteedAIRate':'0.067000','expectedAYield':'0.067000'}
#        
...
#        time.sleep(10)
#        datenow =  (datetime.datetime.now() +  datetime.timedelta(days = 1)).strftime('%Y%m%d')
